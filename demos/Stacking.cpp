...
int main() {
    ...
    ioDescs[1] = Hierarchy::IODesc(Int3(1, 1, numActions), IOType::prediction, 0, 2, 64);
    ioDescs[2] = Hierarchy::IODesc(Int3(1, 1, width), IOType::none, 0, 2, 64);
    ...
    do {
        ...
        if (speedMode || slowTimer >= slowTime) {
            ...
            for (int subTick = 0; subTick < numSubTicks; subTick++) {
                ...
                h.step(inputCIs, goalCIs, actualCIs, speedMode);
